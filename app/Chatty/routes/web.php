...
Route::group(['middleware' => 'auth'], function(){
    ...
    * Upload Voice
    */
    Route::post('upload-voice', 'MessagesController@uploadVoice')->name('upload-voice');

    /*
    * change Agent
    */
    Route::post('client-agent-update', 'MessagesController@changeAgent')->name('client-agent.update');

    /*
    * change Chat Status
    */
    Route::get('change-chat-status', 'MessagesController@changeChatStatus')->name('chat-status.update');

    /*
    * change Chat Status
    */
    Route::get('end-chat', 'MessagesController@endChat')->name('chat-end.update');
