 ...
 */
Route::post('/make-seen', 'MessagesController@seen')->name('api.messages.seen');
 ...
 * Set active status
 */
Route::post('/rateChat', 'MessagesController@rateChat')->name('api.rateChat');

/**
 * Unread Messages
 */
Route::post('/unreadMessages', 'MessagesController@getUnreadMessagesCount')->name('api.unread-count');

/**
 * Notifications
 */
Route::get('/notifications', 'MessagesController@getNotifications')->name('api.notifications');

/**
 * mark Notification as Read
 */
Route::post('/readNotification', 'MessagesController@readNotification')->name('api.read-notification');
